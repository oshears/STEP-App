...
class SnapsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        refreshControl?.addTarget(self, action: #selector(SnapsTableViewController.loadSnapData), forControlEvents:
        ...
        //Load Snaps
        //findSnaps.cachePolicy = .IgnoreCache
    ...
    override func didReceiveMemoryWarning() {
        ...
        print("Low on memory")
        let errorAlert:UIAlertController = UIAlertController(title: "Low Memory", message: "I will crash soon", preferredStyle: UIAlertControllerStyle.Alert)
        errorAlert.addAction(UIAlertAction(title: "Ok", style: .Default, handler: nil))
        self.presentViewController(errorAlert,animated: true, completion: nil)
        findSnaps.clearCachedResult()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell:SnapImageTableViewCell! = tableView.dequeueReusableCellWithIdentifier("SnapCell", forIndexPath: indexPath) as! SnapImageTableViewCell
        if (cell==nil){
            cell.imageImageView.image=UIImage(named: "camera")
    ...
    @IBAction func loadSnapData(){
        ...
        if (pictureList.count==0){
            //findSnaps.cachePolicy = PFCachePolicy.CacheThenNetwork
        }
        ...
        findSnaps.findObjectsInBackgroundWithBlock{
            ...
            if error == nil{
                for object in objects!{
                    ...
                    //snap.saveInBackgroundWithBlock(nil)
                }
                ...
                print("Failed to retrieve snaps from database")
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let saveAction = UIAlertAction(title: "Save Image", style: UIAlertActionStyle.Default, handler:{ alertAction in
            ...
            let confirmationAlert:UIAlertController = UIAlertController(title: "Image Saved!", message: "The image has been saved to your photo library!", preferredStyle: UIAlertControllerStyle.Alert)
